...
class ListaGlicemia extends StatefulWidget {
  ...
  const ListaGlicemia({super.key, required this.idUsuario});
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          child: Text(labelSkipButtom, style: const TextStyle(color: Color.fromRGBO(71, 146, 121, 0.819))),
                        ),
                        ...
                        ElevatedButton(
                          ...
                          child: Text(labelConfirmationButtom, style: const TextStyle(color: Color.fromRGBO(71, 146, 121, 0.819))),
                        ),
                      ],
                    ),
                  ],
